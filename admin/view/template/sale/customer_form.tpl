                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-address<?php echo $address_row; ?>">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-address-3<?php echo $address_row; ?>"><?php echo $entry_address_3; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="address[<?php echo $address_row; ?>][address_3]" value="<?php echo $address['address_3']; ?>" placeholder="<?php echo $entry_address_3; ?>" id="input-address-3<?php echo $address_row; ?>" class="form-control" />
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-state<?php echo $address_row; ?>"><?php echo $entry_zone; ?></label>
                        <div class="col-sm-10">
                          <select name="address[<?php echo $address_row; ?>][state_id]" id="input-state<?php echo $address_row; ?>" class="form-control">
                          </select>
                          <?php if (isset($error_address[$address_row]['state'])) { ?>
                          <div class="text-danger"><?php echo $error_address[$address_row]['state']; ?></div>
                          <?php } ?>
                        </div>
                      </div>
                      <?php foreach ($custom_fields as $custom_field) { ?>
...
function addAddress() {
	...
	html += '  <div class="form-group">';
	html += '    <label class="col-sm-2 control-label" for="input-address-3' + address_row + '"><?php echo $entry_address_3; ?></label>';
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][address_3]" value="" placeholder="<?php echo $entry_address_3; ?>" id="input-address-3' + address_row + '" class="form-control" /></div>';
	html += '  </div>';
