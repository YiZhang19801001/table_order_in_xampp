				...
				<div class="tab-content">
					<div class="tab-pane active" id="tab-order">
						<table class="table table-bordered">
							...
							<tr>
								...
								<td><a href="mailto:<?php echo $shipping_email; ?>"><?php echo $shipping_email; ?></a></td>
							</tr>
							<tr>
							...
							<?php } ?>
							<tr>
								<td><?php echo  $text_shipping_orderTime;?></td>
								<td><?php echo  $shipping_orderTime;?>&nbsp;&nbsp;<?php echo $shipping_orderDate;?></td>
							</tr>
							<?php if ($shipping_method) { ?>
							<tr>
							...
							<tr>
								...
								<td><?php echo $coupon_info['name'] ." : ".$coupon_info['info'] ." ,amount : ".$coupon_info['amount']; ?></td>
							</tr>
							<?php }?>
							<?php if ($ip) { ?>
							<tr>
					...
					<div class="tab-pane" id="tab-payment">
						<table class="table table-bordered">
							...
							<?php } ?>
							<tr>
								<td><?php echo $text_suburb; ?></td>
								<td><?php echo $payment_suburb; ?></td>
							</tr>
							<tr>
					...
					<div class="tab-pane" id="tab-customer">
						<table class="table table-bordered">
							<tr>
								<td><?php echo $text_customer; ?></td>
								<td><?php echo $customer_info['firstname']; ?> <?php echo $customer_info['lastname']; ?></td>
							</tr>
							<tr>
								<td><?php echo $text_email; ?></td>
								<td><a href="mailto:<?php echo  $customer_info['email']; ?>"><?php echo $customer_info['email']; ?></a></td>
							</tr>
							<tr>
							...
							<tr>
								<td><?php echo $text_address_3; ?></td>
								<td><?php echo $address['address_3']; ?></td>
							</tr>
							<?php }?>
							<?php if($coupon_info_text){?>
							<tr>
								<td><?php echo $text_points; ?></td>
								<td><?php echo $coupon_info_text;?></td>
							</tr>
							<?php }?>
						</table>
					</div>
					...
					<div class="tab-pane" id="tab-shipping">
						<table class="table table-bordered">
							...
							<tr>
								<td><?php echo $text_suburb; ?></td>
								<td><?php echo $shipping_suburb; ?></td>
							</tr>
							<tr>
								<td><?php echo $text_state; ?></td>
						...
						<table class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-left">
										<?php foreach($product['exts'] as $ext) {?>
