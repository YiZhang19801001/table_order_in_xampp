            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'r.rating') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'r.rating1') { ?>
                    <a href="<?php echo $sort_rating1; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_rating1; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_rating1; ?>"><?php echo $column_rating1; ?></a>
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'r.rating2') { ?>
                    <a href="<?php echo $sort_rating2; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_rating2; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_rating2; ?>"><?php echo $column_rating2; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo $review['rating1']; ?></td>
                  <td class="text-right"><?php echo $review['rating2']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=localisation/review&token=<?php echo $token; ?>';
