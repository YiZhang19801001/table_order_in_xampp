            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'z.code') { ?>
                    ...
                    <?php } ?></td>                  
                    <td class="text-left"><?php if ($sort == 'z.fee') { ?>
                    <a href="<?php echo $sort_fee; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_fee; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_fee; ?>"><?php echo $column_fee; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $zone['fee']; ?></td>
