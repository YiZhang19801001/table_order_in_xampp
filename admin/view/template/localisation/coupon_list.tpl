          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'c.status') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'c.sort_order') { ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($coupon['shop_coupon_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $coupon['shop_coupon_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $coupon['shop_coupon_id']; ?>" />
                    <?php } ?></td>
                  ...
                  <td class="text-left"><?php echo $coupon['sort_order']; ?></td>
