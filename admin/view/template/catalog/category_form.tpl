...
<!--                   <div class="form-group required">
            ...
            <div class="tab-pane fade" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-shop"><span data-toggle="tooltip" title="<?php echo $help_shop; ?>"><?php echo $entry_shop; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="location" value="<?php echo $location; ?>" placeholder="<?php echo $entry_shop; ?>" id="input-shop" class="form-control" />
                  <input type="hidden" name="location_id" value="<?php echo $location_id; ?>" />
                  <?php if ($error_shop) { ?>
                  <div class="text-danger"><?php echo $error_shop; ?></div>
                  <?php } ?>     
                </div>
              </div>
              <div class="form-group">
