		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-tag" class="form-horizontal">
					...
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-sort"><?php echo $entry_type;?></label>
						<div class="col-sm-10">
							<select name="type" id="input-required" class="form-control">
								<?php if ($type) { ?>
					...
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-checkbox"><?php echo $entry_checkbox;?></label>
						<div class="col-sm-10">
							<select name="checkbox" id="input-checkbox" class="form-control">
								<?php if ($checkbox) { ?>
								<option value="0"><?php echo $text_disabled;?></option>
								<option value="1" selected="selected"><?php echo $text_enabled;?></option>
								<?php } else { ?>
