<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $product_tag; ?>"><?php echo $text_product_tag; ?></a></li>
<!--       <li><a class="parent"><?php echo $text_attribute; ?></a>
      ...
      <li><a href="<?php echo $add_type; ?>"><?php echo $text_add_type; ?></a></li>
      <!--#@-->
...
<!--       <li><a class="parent"><?php echo $text_voucher; ?></a>
  ...
  <li><a class="parent"><i class="fa fa-share-alt fa-fw"></i> <span><?php echo $text_marketing; ?></span></a>
    <ul>
      <li><a href="<?php echo $localisation_conpou; ?>"><?php echo $text_localisation_conpou; ?></a></li>
      <li><a href="<?php echo $localisation_product; ?>"><?php echo $text_localisation_product; ?></a></li>
...
<!--       <li><a class="parent"><?php echo $text_design; ?></a>
      ...
      <li><a class="parent"><?php echo $text_localisation; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $localisation_state; ?>"><?php echo $text_localisation_state; ?></a></li>
          <li><a href="<?php echo $localisation_suburb; ?>"><?php echo $text_localisation_suburb; ?></a></li>
          <li><a href="<?php echo $geo_zone; ?>"><?php echo $text_geo_zone; ?></a></li>
          <li><a href="<?php echo $shop_review; ?>"><?php echo $text_shop_review; ?></a></li>
