...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_localisation_conpou'] = $this->language->get('text_localisation_conpou');
		$data['text_localisation_product'] = $this->language->get('text_localisation_product');
		$data['text_localisation_state'] = $this->language->get('text_localisation_state');
		$data['text_localisation_suburb'] = $this->language->get('text_localisation_suburb');
		$data['text_add_type'] = $this->language->get('text_add_type');
		$data['text_shop_review'] = $this->language->get('text_shop_review');
		#@
		...
		#@
		$data['tag'] = $this->url->link('catalog/tag', 'token=' . $this->session->data['token'], 'SSL');
		$data['product_tag'] = $this->url->link('catalog/product_tag', 'token=' . $this->session->data['token'], 'SSL');
		$data['localisation_conpou'] = $this->url->link('localisation/coupon', 'token=' . $this->session->data['token'], 'SSL');
		$data['localisation_product'] = $this->url->link('localisation/product', 'token=' . $this->session->data['token'], 'SSL');
		$data['localisation_state'] = $this->url->link('localisation/state', 'token=' . $this->session->data['token'], 'SSL');
		$data['localisation_suburb'] = $this->url->link('localisation/suburb', 'token=' . $this->session->data['token'], 'SSL');
		$data['add_type'] = $this->url->link('catalog/add_type', 'token=' . $this->session->data['token'], 'SSL');
		$data['shop_review'] = $this->url->link('localisation/review', 'token=' . $this->session->data['token'], 'SSL');
