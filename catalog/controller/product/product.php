...
class ControllerProductProduct extends Controller {
	...
	public function write() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			if (empty($this->request->post['rating1']) || $this->request->post['rating1'] < 0 || $this->request->post['rating1'] > 5) {
				$json['error'] = $this->language->get('error_rating');
			}

			if (empty($this->request->post['rating2']) || $this->request->post['rating2'] < 0 || $this->request->post['rating2'] > 5) {
				$json['error'] = $this->language->get('error_rating');
			}
