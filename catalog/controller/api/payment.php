...
class ControllerApiPayment extends Controller {
	public function address() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			// 	$json['error']['suburb'] = $this->language->get('error_suburb');
			// }
			...
			if (!$json) {
				...
				$state_info = $this->model_localisation_state->getState($this->request->post['state_id']);
				...
				$suburb_info = $this->model_localisation_suburb->getSuburb($this->request->post['suburb_id']);
				...
				$this->session->data['payment_address'] = array(
					...
					'country'        => $country,
					'suburb_id'     => $this->request->post['suburb_id'],
					'suburb'        => $suburb,
				);
	...
	public function methods() {
		...
		$json = array();
		$this->session->data['location_id'] = 4;
