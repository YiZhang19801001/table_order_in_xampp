...
<head>
    ...
    #summaryCartType, .message .success, input[type=checkbox]:checked+label::before, .slim-import a:hover, .core-popover .core-closeX, .orderSubmittedMessage .fa-check-circle, .tACheckoutCompletePage .number, .tACheckoutCompletePage .hashtag, .tACheckoutCompletePage .what-happens-next span.counter
    {
        color: <?php echo $_SESSION['color'];?>!important;
    }
    ...
    form.takeawayCheckout input[type=radio]:checked+label.radio
    {
        color: <?php echo $_SESSION['color'];?>!important;
        border-color: <?php echo $_SESSION['color'];?>!important;
    }
    .signUp, ._rv-item-holder ._item ._pbar ._bar, div.addReview .ui-widget-header
    {
        background-color: <?php echo $_SESSION['color'];?>!important;
    }
    ...
    {
        background: <?php echo $_SESSION['color'];?>!important;
    }
    div.addReview .ui-state-default, .ui-widget-content .ui-state-default, .ui-widget-header .ui-state-default
    {
        /*background: ;*/
    ...
    #w23SignUpBtn, form.takeawayCheckout .checkoutButton, .button, .orderNow, .core-dialogueButtons button, #login
    {
        background-color: <?php echo $_SESSION['color1'];?>!important;
    }
    .message .error, .col1 > p.restName, ._review-item ._user-info ._review-cnt a, .attention
    {
        color: <?php echo $_SESSION['color1'];?>!important;
    }
	</style>
	...
	$(function() {
		...
		$('#link_login').click(function() {
            ...
            $('.linkLogin').css({
                'position': 'absolute',
                'top': '65px',
            	'left': $(event.target).offset().left - 120 + 'px',
		...
		$("#bestPricePolicyWrapper").hover(function(){
            $(".bestPricePolicy").css('left', $(event.target).offset().left - 50);
...
<div class="core-popoverBox core-popoverNoTitle core-popoverHelper  core-popover bestPricePolicy" style="z-index: 10000; max-width: 275px; width: 275px; position: absolute; top: 74px; left: 0;">
...
<?php if (!$logged) { ?>
<div class="core-popoverBox core-popoverNoTitle core-popoverHelper  core-popover core-popoverFocused linkLogin ui-draggable ui-draggable-handle core-popoverDraggable" style="z-index: 10000; position: absolute; width: 234px; top: 65px; left: 0; display: block;">
	<a class="core-closeX"></a>
	<div class="core-contentBox core-contentBoxNoTitle">
		<div class="core-ifhBlock" style="display: block;">
			<div class="core-ifhBlock">
				...
				<div class="forgottenPassword">
					<div class="loginLHS">
						<div id="message_forgotten" class="message" style="display: none;"><span class="error">Please enter your current email.</span></div>
						<p id ="forgottenPassword" style="display: none">We have e-mailed you a password reset link. Please check your spam folder if you can't find it in the inbox.</p>
						<fieldset id="forgetpwd_hiden">
							...
							<div class="core-dialogueButtons">
								<div class="core-left">
								<button type="submit" id="f_Password">RESET PASSWORD</button>
								</div>
								<div class="core-left">
...
<div id="takeawayPage" class="pageBody">
	<div class="fullWidthWrapper1 header" id="takeawayHeader">
		<div class="fullWidthWrapper2 theme-color">
			<div class="fullWidthWrapper3">
				<div class="flex-container flex-container-center headerTop" id="takeawayHeaderTop" style="min-height: 80px">
					<div class="flex-item logoTakeaway">
                        <a href="<?php echo $home;?>">
                            <!-- <span class="icon-logoWide"></span> -->
						...
						<div class="flex-container flex-container-center">
							<div class="flex-item">
								<!--<div id="bestPricePolicyWrapper">-->
									<!--<a href="#" id="bestPricePolicyIconLink"><img src="/catalog/view/theme/menulog/image/icon_bestPrice.png">&nbsp;Best price guaranteed&nbsp;<i class="fa fa-caret-down" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
								<!--</div>-->
								<?php if(!$logged){ ?>
							...
							<div class="flex-item">
								...
								<ul class="navUser">
									...
									<!--</li>-->
									<?php if($logged){?>
									<li><a  href="javascript:void(0)" id="link_myAccount" class="jsMyAccountPopover"><?php echo $first_name;?></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $order;?>" class="reOrder">Re-order</a></li>
									<?php }else{ ?>
									<li><a  id="link_login" href="javascript:void(0)" class="jsLoginPopover">Login</a></li>
									<?php }?>
								</ul>
								<ul id="template_myAccountNavs">
									<li><a href="<?php echo $order;?>">My Orders</a></li>
