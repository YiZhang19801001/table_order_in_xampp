...
<head>
    ...
    <style>
        #CreditCardTokenization1_PayPal1_btnBackToOrder, #CreditCardTokenization1_PayPal1_btnSave {
            background-color: < ? php echo $ _SESSION [ 'color1' ];
            ? > !important;
        }
    ...
    <div class="container">
        <div id="CreditCardTokenization1_PayPal1_panel1">
            <div class="container">
                ...
                <div class="sectionTitle">Payment Summary 123</div>
                <p></p>
                <div class="Outer">
                    <div class="borderM">
                        <div class="DisplayTitle"><span
                                id="CreditCardTokenization1_PayPal1_ReferenceCode">Order Number</span></div>
                        <div class="DisplayTopText DisplayTextMobileNoStack"><span
                                id="CreditCardTokenization1_PayPal1_lblReferenceCode"><?php echo $order_id;?></span>
                        </div>
                        <div class="contentEnd"></div>
                    </div>
                </div>
                <div class="Outer">
                    <div class="borderM">
                        <div class="DisplayTitle"><span id="CreditCardTokenization1_PayPal1_Amount">Your Order</span>
                        </div>
                        <div class="DisplayTopText DisplayTextMobileNoStack"><span
                                id="CreditCardTokenization1_PayPal1_lblAmount"><?php echo $total_text;?></span></div>
                        <div class="contentEnd"></div>
                    </div>
                </div>
                <div class="Outer">
                    <div class="NoborderM">
                        <div class="DisplayTitle"><b><span
                                id="CreditCardTokenization1_PayPal1_Charge">You Pay</span></b></div>
                        <div class="DisplayTopText DisplayTextMobileNoStack"><b><span
                                id="CreditCardTokenization1_PayPal1_lblTotalAmount"><?php echo $total_text;?></span></b>
                        </div>
                        <div class="contentEnd"></div>
                    </div>
                </div>
                ...
                <div class="menulogText" id="spnLoadingProcess" style="display:none">
                    <div>
                        <font class="menulogText"><strong><font color="red"><span
                                id="CreditCardTokenization1_PayPal1_Label1">Redirecting to PayPal...</span></font></strong></font>
                ...
                <form action="<?php echo $action; ?>" method="post">
                    ...
                    <input type="hidden" name="on<?php echo $j; ?>_<?php echo $i; ?>"
                    ...
                    <div class="menulogText">
                        <a id="CreditCardTokenization1_PayPal1_btnBackToOrder" class="MenuLogBackToOrderWeb"
                           href="<?php echo $cancel_return;?>" style="text-decoration:none;">Back To Order</a>
                        <input type="submit" name="CreditCardTokenization1$PayPal1$btnSave" value="Submit Order"
                               id="CreditCardTokenization1_PayPal1_btnSave" class="MenuLogContinueWeb">
                    </div>
                    <div>
                    ...
                    <br>
                    <br>
                    <img src="https://www.paypalobjects.com/webstatic/en_AU/mktg/logo/bdg_payments_by_pp_2line_163x44.png"
                         alt="PayPal Logo" style="display:block;margin-left:auto;margin-right:auto">
                    <div class="contentEnd"></div>
                    <p></p>
                    <div>
